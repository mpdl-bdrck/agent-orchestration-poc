...
# Step 1: Python Environment Setup (skip if testing sheets)
if [ -z "$TEST_SHEETS_DIR" ]; then
print_step "🐍 Step 1: Python Environment Setup"
...
if [ "$EXTRACT_FORMULAS" = true ]; then
    print_step "🚀 Step 3: Running Formula Extraction"
    ...
    print_step "🚀 Step 3: Running Google Sheets Test Publishing"
    ...
    print_step "🚀 Step 3: Running Campaign Spend Analysis"
