...
Handles timezone conversion for billing dates using client config.
"""
...
class TimezoneHandler:
    ...
    def from_client_name(cls, client_name):
        """
        Factory method to create handler from client name
        
        Args:
            client_name (str): Name of the client (e.g., "Tricoast")
            
        Returns:
            TimezoneHandler: Configured handler instance
        """
